...
#define DEFAULT_RSTVEC 0x00001000 // version de 32 bits

#endif

#ifdef RV64
    
#define DEFAULT_RSTVEC 0xFFFFFFFF80000000 // Version de 64 bits
...
extern uint32_t check_cache;
extern uint32_t crep_value;
